...
const heroContent = {
  ...
  heroDescriptions: `Bonjour, je suis développeur Web Fullstack JavaScript avec une spécialisation en front-end (ReactJS 💛). Vous retrouverez sur ce portfolio mes différentes créations avec une description du travail réalisé. Bonne visite !`,
  heroBtn: "Mon profil",
};
